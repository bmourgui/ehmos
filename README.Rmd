...
The [:file: make.R](/make.R) allow to run the entire workflow used to produce the manuscript. However, fitting models on simulated data could several days to run. The **analysis** directory contains scripts that have been used to conduct the simulation (scripts starting with 'simu') and application (scripts starting with 'appli') analysis presented in the manuscript. Scripts have to be run following the order mentioned in their names. 
